...
{
		HX_STACK_FRAME("haxe.io.Bytes","blit",0xd098ac78,"haxe.io.Bytes.blit","D:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",75,0x3833ab2b)
		HX_STACK_THIS(this)
...
::haxe::io::Bytes Bytes_obj::sub( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","sub",0x393cae9d,"haxe.io.Bytes.sub","D:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",127,0x3833ab2b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(129)
...
::String Bytes_obj::getString( int pos,int len){
	HX_STACK_FRAME("haxe.io.Bytes","getString",0xa16beae4,"haxe.io.Bytes.getString","D:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",261,0x3833ab2b)
	HX_STACK_THIS(this)
	HX_STACK_ARG(pos,"pos")
	HX_STACK_ARG(len,"len")
	HX_STACK_LINE(263)
...
::String Bytes_obj::toString( ){
	HX_STACK_FRAME("haxe.io.Bytes","toString",0x0291226f,"haxe.io.Bytes.toString","D:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",335,0x3833ab2b)
	HX_STACK_THIS(this)
	HX_STACK_LINE(335)
...
::haxe::io::Bytes Bytes_obj::alloc( int length){
	HX_STACK_FRAME("haxe.io.Bytes","alloc",0x2199ead2,"haxe.io.Bytes.alloc","D:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",357,0x3833ab2b)
	HX_STACK_ARG(length,"length")
	HX_STACK_LINE(367)
...
::haxe::io::Bytes Bytes_obj::ofString( ::String s){
	HX_STACK_FRAME("haxe.io.Bytes","ofString",0x6e53bb0b,"haxe.io.Bytes.ofString","D:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",382,0x3833ab2b)
	HX_STACK_ARG(s,"s")
	HX_STACK_LINE(393)
	Array< unsigned char > a = Array_obj< unsigned char >::__new();		HX_STACK_VAR(a,"a");
	HX_STACK_LINE(394)
...
::haxe::io::Bytes Bytes_obj::ofData( Array< unsigned char > b){
	HX_STACK_FRAME("haxe.io.Bytes","ofData",0x4f3005e4,"haxe.io.Bytes.ofData","D:\\HaxeToolkit\\haxe\\std/haxe/io/Bytes.hx",445,0x3833ab2b)
	HX_STACK_ARG(b,"b")
	HX_STACK_LINE(445)
