...
{
HX_STACK_FRAME("haxe.ds.ObjectMap","new",0x27af5498,"haxe.ds.ObjectMap.new","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",29,0x6e4de3df)
HX_STACK_THIS(this)
{
	HX_STACK_LINE(30)
...
{
		HX_STACK_FRAME("haxe.ds.ObjectMap","set",0x27b31fda,"haxe.ds.ObjectMap.set","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",34,0x6e4de3df)
		HX_STACK_THIS(this)
...
Dynamic ObjectMap_obj::get( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","get",0x27aa04ce,"haxe.ds.ObjectMap.get","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",40,0x6e4de3df)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(41)
...
bool ObjectMap_obj::remove( Dynamic key){
	HX_STACK_FRAME("haxe.ds.ObjectMap","remove",0x0d3b8b0c,"haxe.ds.ObjectMap.remove","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",48,0x6e4de3df)
	HX_STACK_THIS(this)
	HX_STACK_ARG(key,"key")
	HX_STACK_LINE(49)
	int id = ::__hxcpp_obj_id(key);		HX_STACK_VAR(id,"id");
...
Dynamic ObjectMap_obj::keys( ){
	HX_STACK_FRAME("haxe.ds.ObjectMap","keys",0x8fbf0ebc,"haxe.ds.ObjectMap.keys","D:\\HaxeToolkit\\haxe\\std/cpp/_std/haxe/ds/ObjectMap.hx",55,0x6e4de3df)
	HX_STACK_THIS(this)
	HX_STACK_LINE(55)
